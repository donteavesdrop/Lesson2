package ru.mirea.zakharova.dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPickDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ru.mirea.zakharova.dialog.MyDateDialogFragment mDatePickerDialogFragment;
                mDatePickerDialogFragment = new ru.mirea.zakharova.dialog.MyDateDialogFragment();
